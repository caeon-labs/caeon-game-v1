function Loading() {
    ...
    this.enter = function() {
        ...
        if (!checkImages()) {
            // chieu thuc
            images.rocket = loadImage('images/c.png');
            images.stormCircle = loadImage('images/b.png');
            images.lockLight = loadImage('images/d.png');
            images.handAttack = loadImage('images/a.png');
