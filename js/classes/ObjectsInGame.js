...
class BaoKiem_Yasuo extends Moveable_Ability_Object {
    constructor(_owner, _data) {
        _data.image = images.stormCircle; // thêm thuộc tính image cho dữ liệu (kiểu ocject {}) _data
        super(_owner, _data);
...
class handAttackHoaTien_Blit extends Moveable_Ability_Object {
    constructor(_owner, _data) {
        _data.image = images.handAttack;
        super(_owner, _data);
